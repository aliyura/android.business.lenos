package syrol.business.lenos.com.ng;
...
//                                )
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                if (!isConnected()) {
                    startActivity(new Intent(getApplicationContext(), syrol.business.lenos.com.ng.NetworkError.class).putExtra("page","network_error"));
                    finish();
                } else {
                    app.loadUrl(url);
                }
